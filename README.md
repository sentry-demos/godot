...
- Clone this demo repo locally so you can run the game
...
**Objective:** Jump to the red flag on the right. When you reach it, the demo will intentionally crash to showcase Sentry's crash reporting capabilities!
